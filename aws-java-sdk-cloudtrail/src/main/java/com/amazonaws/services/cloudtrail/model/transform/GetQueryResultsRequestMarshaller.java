...
public class GetQueryResultsRequestMarshaller {
    ...
    private static final MarshallingInfo<Integer> MAXQUERYRESULTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MaxQueryResults").build();
    ...
    public void marshall(GetQueryResultsRequest getQueryResultsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getQueryResultsRequest.getEventDataStore(), EVENTDATASTORE_BINDING);
            ...
            protocolMarshaller.marshall(getQueryResultsRequest.getMaxQueryResults(), MAXQUERYRESULTS_BINDING);
        } catch (Exception e) {
