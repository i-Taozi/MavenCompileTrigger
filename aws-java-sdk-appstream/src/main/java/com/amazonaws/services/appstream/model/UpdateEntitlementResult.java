...
public class UpdateEntitlementResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEntitlementResult == false)
            return false;
        UpdateEntitlementResult other = (UpdateEntitlementResult) obj;
    ...
    @Override
    public UpdateEntitlementResult clone() {
        try {
            return (UpdateEntitlementResult) super.clone();
