...
public class PermissionTypeMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private PermissionTypeMismatchExceptionUnmarshaller() {
        super(com.amazonaws.services.glue.model.PermissionTypeMismatchException.class, "PermissionTypeMismatchException");
    }

    @Override
    public com.amazonaws.services.glue.model.PermissionTypeMismatchException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.glue.model.PermissionTypeMismatchException permissionTypeMismatchException = new com.amazonaws.services.glue.model.PermissionTypeMismatchException(
                null);
