...
/**
 * DeltaTarget JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeltaTargetJsonUnmarshaller implements Unmarshaller<DeltaTarget, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeltaTables", targetDepth)) {
                    context.nextToken();
                    deltaTarget.setDeltaTables(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
