...
/**
 * JobExecutionsRetryConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JobExecutionsRetryConfigJsonUnmarshaller implements Unmarshaller<JobExecutionsRetryConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("criteriaList", targetDepth)) {
                    context.nextToken();
                    jobExecutionsRetryConfig.setCriteriaList(new ListUnmarshaller<RetryCriteria>(RetryCriteriaJsonUnmarshaller.getInstance())
