...
/**
 * DeleteQueuedMessagesResult JSON Unmarshaller
 */
...
public class DeleteQueuedMessagesResultJsonUnmarshaller implements Unmarshaller<DeleteQueuedMessagesResult, JsonUnmarshallerContext> {
    ...
    public DeleteQueuedMessagesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteQueuedMessagesResult deleteQueuedMessagesResult = new DeleteQueuedMessagesResult();

        return deleteQueuedMessagesResult;
    }
